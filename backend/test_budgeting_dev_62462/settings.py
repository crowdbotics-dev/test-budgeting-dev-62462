"""
Django settings for test_budgeting_dev_62462 project.
...
ROOT_URLCONF = 'test_budgeting_dev_62462.urls'
...
WSGI_APPLICATION = 'test_budgeting_dev_62462.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_budgeting_dev_62462 API",
    "DESCRIPTION": "API documentation for test_budgeting_dev_62462 App",
    "VERSION": "v1",
}
